...
public class BF_Hit : MonoBehaviour
{
    public int dano = 1;
    ...
    private void Start()
    {
        ...
        if (patrol == null)
        {
            Debug.Log("BF_Patrol n?o foi atribuido");
        }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            // Aplica dano
            BF_HealthSystem healthSystem = collision.GetComponent<BF_HealthSystem>();
    ...
    private IEnumerator AplicarKnockbackComDelay(Rigidbody2D playerRb, Vector2 knockbackDir, float duracaoControleDesativado)
    {
        ...
        BF_MovPlataformer mov = playerRb.GetComponent<BF_MovPlataformer>();
