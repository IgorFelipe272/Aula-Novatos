...
public class IF_HealthSystem : MonoBehaviour
{
    public int vida = 5;
    ...
    public IF_LifeUIController uiController;
    ...
    public void TakeDamage(int amount)
    {
        ...
        if (vida <= 0)
        {
            ...
            {
                // Lógica especial para o jogador
    ...
    {
        estaInvencivel = true;
        // Aqui você pode adicionar um efeito visual, tipo piscar o sprite
